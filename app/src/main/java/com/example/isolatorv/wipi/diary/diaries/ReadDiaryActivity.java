...
import com.example.isolatorv.wipi.diary.chart.BarChartActivity;
...
import com.example.isolatorv.wipi.diary.timeline.TimelineActivity;
...
public class ReadDiaryActivity extends EasyDiaryActivity {
    ...
    private void initShowcase() {
        ...
        mShowcaseView = new ShowcaseView.Builder(this)
                ...
                .singleShot(DiaryConstants.SHOWCASE_SINGLE_SHOT_READ_DIARY_NUMBER)
...
//                ReadDiaryActivity.this.overridePendingTransition(R.anim.anim_right_to_center, R.anim.anim_center_to_left);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_SPEECH_INPUT:
                ...
                CommonUtils.saveLongPreference(ReadDiaryActivity.this, DiaryConstants.PAUSE_MILLIS, System.currentTimeMillis());
                break;
        }
    }
    ...
    protected void onResume() {
        ...
        int previousActivity = CommonUtils.loadIntPreference(ReadDiaryActivity.this, DiaryConstants.PREVIOUS_ACTIVITY, -1);
...
//            mDiaryListView.setSelection(0);
            CommonUtils.saveIntPreference(ReadDiaryActivity.this, DiaryConstants.PREVIOUS_ACTIVITY, -1);
        }
    }
