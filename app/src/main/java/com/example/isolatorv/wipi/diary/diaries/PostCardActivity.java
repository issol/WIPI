...
public class PostCardActivity extends EasyDiaryActivity {
    ...
    private void initShowcase() {
        ...
        mShowcaseView = new ShowcaseView.Builder(this)
                ...
                .singleShot(DiaryConstants.SHOWCASE_SINGLE_SHOT_POST_CARD_NUMBER)
...
//                        .setColorEditTextColor(ContextCompat.getColor(PostCardActivity.this, android.R.color.holo_blue_bright))
            ...
            case R.id.share:
                if (PermissionUtils.checkPermission(this, DiaryConstants.EXTERNAL_STORAGE_PERMISSIONS)) {
                    ...
                    // API Level 23 이상이면서 권한취득 안한경우
                    PermissionUtils.confirmPermission(this, this, DiaryConstants.EXTERNAL_STORAGE_PERMISSIONS, DiaryConstants.REQUEST_CODE_EXTERNAL_STORAGE_WITH_SHARE_DIARY_CARD);
                }
                break;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode) {
            case DiaryConstants.REQUEST_CODE_EXTERNAL_STORAGE:
                ...
                break;
            case DiaryConstants.REQUEST_CODE_EXTERNAL_STORAGE_WITH_SHARE_DIARY_CARD:
                if (PermissionUtils.checkPermission(this, DiaryConstants.EXTERNAL_STORAGE_PERMISSIONS)) {
                    // 권한이 있는경우
                    exportDiaryCard(false);
                } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case DiaryConstants.REQUEST_CODE_BACKGROUND_COLOR_PICKER:
...
//                    mContentsContainer.setBackgroundDrawable(shape);
                ...
                break;
            case DiaryConstants.REQUEST_CODE_TEXT_COLOR_PICKER:
                if ((resultCode == RESULT_OK) && (data != null)) {
                    String hexStringColor = "#" + data.getStringExtra("color");
